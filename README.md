...
- [Hover.css 集](http://ianlunn.github.io/Hover/)
- [EpicSpinners-Loading 集](https://epic-spinners.epicmax.co/#/)
...
- [git-flight-rules 使用 Git 遇到问题了？](https://github.com/k88hudson/git-flight-rules/blob/master/README_zh-CN.md)
- [commit 的参考规范](https://www.conventionalcommits.org/en/v1.0.0/)

### 移动端

- [一键生成所有尺寸的启动图与图标](https://icon.wuruihong.com/)
- [Secharts-RN 图表组件库](https://github.com/shifeng1993/react-native-secharts)

### 组件

- [React-Hook-Form](https://react-hook-form.com/zh/)
- [js 实现的 Github 头像生成器](https://github.com/stewartlord/identicon.js)
...
- [FreeStockPhotos 图库](https://taken.photos/)
- [The Art Institute of Chicago 高清画集](https://www.artic.edu/collection)
...
- [BTBBT](http://www.btbtdy.me/)
- [BYG 影视](http://www.byg521.com/)
...
- [NoMoreGoogle 谷歌的替代](https://nomoregoogle.com/)

### 杂

- [Sci-Hub 科学论文下载](https://whereisscihub.now.sh/)
- [不用翻墙的 Chrome 扩展商店](http://chromecj.com/)
...
- [东京地铁实时 3D 图](https://nagix.github.io/mini-tokyo-3d/)
- [可以打印下来的折纸地球仪](https://mapscaping.com/pages/folding-paper-globes)
- [基于 WebGL 实现的酷炫流体渲染效果](https://paveldogreat.github.io/WebGL-Fluid-Simulation/)
- [整个页面都是 3D 的个人主页，真的酷](https://bruno-simon.com/)
...
- [把游戏做成操作系统，U 盘插入即启动！](https://github.com/CasterWx/AntzGameOS)
